...
public class pSilver extends Piece{
    public pSilver(Board board, int col, int row, boolean isWhite, boolean isPromoted) {
        super(board);
        this.col = col;
        this.row = row;
        ...
        this.name = "Promoted Silver General";


        this.sprite = sheet.getSubimage(4 * sheetScale, super.RowHi() * sheetRow, sheetScale, sheetScale)
