...
public class pKnight extends Piece{
    public pKnight(Board board, int col, int row, boolean isWhite, boolean isPromoted) {
        super(board);
        this.col = col;
        this.row = row;
        ...
        this.name = "Promoted Knight";


        this.sprite = sheet.getSubimage(5 * sheetScale, super.RowHi() * sheetRow, sheetScale, sheetScale)
