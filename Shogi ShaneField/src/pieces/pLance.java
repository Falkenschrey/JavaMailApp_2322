...
public class pLance extends Piece{
    public pLance(Board board, int col, int row, boolean isWhite, boolean isPromoted) {
        super(board);
        this.col = col;
        this.row = row;
        ...
        this.name = "Promoted Lance";


        this.sprite = sheet.getSubimage(6 * sheetScale, super.RowHi() * sheetRow, sheetScale, sheetScale)
