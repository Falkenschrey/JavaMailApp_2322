...
public class Silver extends Piece{
    public Silver(Board board, int col, int row, boolean isWhite, boolean isPromoted) {
        super(board);
        this.col = col;
        this.row = row;
        ...
        this.name = "Silver General";


        this.sprite = sheet.getSubimage(4 * sheetScale, super.RowHi() * sheetRow+5, sheetScale, sheetScale)
